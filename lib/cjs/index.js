...
var _server_listener, _listener, _connection_wait, _uploads, _connect, _handlers, _io, _readBlock, _dedupe;
...
class Client {
    constructor(url) {
        ...
        _io.set(this, () => {
            return new Promise((resolve, reject) => {
                ...
                if (!this.ws) {
                    ...
                    __classPrivateFieldGet(this, _connect).call(this)
        ...
        console.log(worker_js_1.default.toString());
    }
}
exports.default = Client;
_server_listener = new WeakMap(), _listener = new WeakMap(), _connection_wait = new WeakMap(), _uploads = new WeakMap(), _connect = new WeakMap(), _handlers = new WeakMap(), _io = new WeakMap(), _readBlock = new WeakMap(), _dedupe = new WeakMap();
