...
var _server_listener, _listener, _connection_wait, _uploads, _worker, _connect, _handlers, _io, _readBlock, _dedupe;
...
_server_listener = new WeakMap(), _listener = new WeakMap(), _connection_wait = new WeakMap(), _uploads = new WeakMap(), _worker = new WeakMap(), _connect = new WeakMap(), _handlers = new WeakMap(), _io = new WeakMap(), _readBlock = new WeakMap(), _dedupe = new WeakMap();
